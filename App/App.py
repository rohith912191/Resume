# Developed by AGGANNAGARI ROHITH REDDY    Made with Streamlit
# Email: rohith912191@gmail.com | Phone: 9121916107 | Anurag University, Hyderabad
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="#" style="text-decoration: none; color: #021659;">AGGANNAGARI ROHITH REDDY</a> | 📧 rohith912191@gmail.com</b>' 
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            try:
                ...
                if "add()" in str(e):
                    st.error("Resume parsing service error. This may be due to a compatibility issue.")
                    st.info("Please try uploading a different resume or contact support.")
                else:
                    st.error(f"Error parsing resume: {str(e)}")
                    st.info("Please ensure your resume is a valid PDF file.")
                resume_data = None
            except Exception as e:
                st.error(f"Error parsing resume: {str(e)}")
                st.info("Please ensure your resume is a valid PDF file.")
    ...
    ###### CODE FOR FEEDBACK SIDE ######
        ...
        if DB_AVAILABLE and connection is not None:
            try:
                ...
                st.info("Feedback data will be available after database is connected.")
                print(f"Feedback error: {e}")
        else:
            st.info("Database is not available. Feedback functionality is disabled. To enable, please start MySQL server.")
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>Rohith</b> as username and <b>Rohith@91</b> as password.<br/>
            It will load all the required stuffs and perform analysis.
        </p><br/><br/>

        <p align="justify">
            Built with 🤍 by 
            <a href="#" style="text-decoration: none; color: grey;">AGGANNAGARI ROHITH REDDY</a><br/>
            <b>Email:</b> rohith912191@gmail.com | <b>Phone:</b> 9121916107 | <b>University:</b> Anurag University, Hyderabad
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'Rohith' and ad_password == 'Rohith@91':
                
                if not DB_AVAILABLE or cursor is None:
                    st.error("Database is not available. Please start MySQL server and restart the application.")
                else:
                    try:
